...
public class GetItems_Account {
	
	public ArrayList<HashMap<String, Object>> getItems_Account() {
        ...
        query1.whereEqualTo("process_situation", "finish");
        		...
        		if (e == null) {
                	...
                	for(int i = 0; i<objects.size(); i++){
                		...
                		if(currentUsername.equals(phonenumber1)) {
                			...
                			map.put("accountlist_username", user2);
	                		map.put("accountlist_credit", money_situation_symbol+credit_String);     //below is the part of display on the device of First user(the activity starter)
	                        map.put("accountlist_phonenumber", phonenumber2);
                			...
                			map.put("accountlist_username", user1);
                    		map.put("accountlist_credit", money_situation_symbol+credit_String);     //below is the part of display on the device of Second user
                            map.put("accountlist_phonenumber", phonenumber1);
                            map.put("accountlist_date", recharge_date_string);
                            //map.put("alertlist_phonenumber_receiver", phonenumber_receiver);
                            //map.put("alertlist_money_situation", money_situation);
                            map.put("accountlist_index", "2");
                            items.add(map);
